...
from .views import idea_add_team_member
from .views import idea_creation, idea_detail, idea_list_complete, idea_list_validated
...
urlpatterns = [
    ...
    path('<int:idea_id>/add/', idea_add_team_member, name='idea_add_team_member'),
